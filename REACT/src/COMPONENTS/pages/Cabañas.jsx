  ...
  return (
    <>
      ...
      <ul className="servicesList">
        ...
        <li>Precio: ARS ##.### x 1 Persona x 1 Noche.</li>

        <li>2 Cuchetas (2 personas cada una).</li>

        <li>Cama Matrimonial.</li>

        <li>Agregable: 1 Colchón.</li>

        <li>WIFI Gratis.</li>

        <li>Parrilla (Llevar alimentos y materiales correspondientes).</li>

        <li>Horno Eléctrico.</li>

        <li>Horno a Gas.</li>

        <li>Parking Privado Gratis sin necesidad de Reserva.</li>
        ...
        <li>Se reciben mascotas, gratis.</li>
      </ul>
